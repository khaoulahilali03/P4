package com.parkit.parkingsystem.constants;
        ...
        // This class introduce all the database constants that are used in the application
public class DBConstants {
    ...
    public static final String CHECK_IF_RECCURENT = " select count(*) from ticket where VEHICLE_REG_NUMBER=?";
